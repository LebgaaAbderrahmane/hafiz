...
class _$SessionCopyWithImpl<$Res, $Val extends Session>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      type: null == type ? _value.type : type as SessionType,
      date: null == date ? _value.date : date as DateTime,
      startTime: null == startTime ? _value.startTime : startTime as String,
      endTime: null == endTime ? _value.endTime : endTime as String,
      ...
      status: null == status ? _value.status : status as SessionStatus,
...
class _$SessionImpl implements _Session {
  ...
  @override
  String toString() {
    return 'Session(id: $id, organizationId: $organizationId, branchId: $branchId, title: $title, description: $description, type: $type, date: $date, startTime: $startTime, endTime: $endTime, classId: $classId, teacherId: $teacherId, studentIds: $studentIds, location: $location, status: $status, notes: $notes, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
